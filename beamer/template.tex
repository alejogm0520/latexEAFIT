...
% Cover
% Use the option "cover=white" to set the background in white and the
% logos and, font in blue. User the option "cover=blue" to set the
% background in blue and the logos, and font in white. 
...
\usetheme[language=EN, color=white, cover=white]{EAFIT}
\usepackage{pgfpages}
