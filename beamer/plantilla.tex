...
% Font Color
% Use the option "fontc=black" to set the font color in black. If this argument is not given the default color is set depending of the color scheme selected.
...
\def\carrera{Maestria en Matemáticas Aplicadas}
